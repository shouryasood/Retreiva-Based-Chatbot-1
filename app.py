...
def processRequest(req):
    ...
    if (intent == 'countries'):                                                   # for the country-intent
        ...
        EMAIL_ADDRESS = os.environ.get('shouryasoodib@gmail.com')             # Enter your GMail Here
        EMAIL_PASSWORD = os.environ.get('X9888834073X&')            # Enter your GMail's Password Here
